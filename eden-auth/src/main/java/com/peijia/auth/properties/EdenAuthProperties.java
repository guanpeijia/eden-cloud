 ...
 * @desc @PropertySource(value = {"classpath:febs-auth.properties"})用于指定读取的配置文件路径；
*  @desc @ConfigurationProperties(prefix = "febs.auth")指定了要读取的属性的统一前缀名称为febs.auth；@SpringBootConfiguration实质上为
