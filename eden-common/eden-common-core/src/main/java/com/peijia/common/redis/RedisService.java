...
public class RedisService {
    ...
    /**
     * 递增
     *  String在redis内部存储默认就是一个字符串，当遇到增减类incr，decr时会转成数值型进行计算
     ...
     * @param key 键
     * @param map 对应多个键值 FIELD1 VALUE1 到 FIELDN VALUEN
    ...
    /**
     * 根据value从一个set中查询, 判断成员元素是否是集合的成员
     *
     * @param key   键
     * @param value 值
     * @return true 存在 false不存在
